...
// Colors         // HSV      // RGB            // Full name colors
#define AL_Green  {219,39,21} // 1,136,80       // Aurora light green
#define A_Blue    {219,39,21} // 0x00,0xFF,0xAD // Aurora blue
#define AB_Yellow {219,39,21} // 0xD9,0xBB,0x63 // Aurora brown yellow
#define AL_Pink   {219,39,21} // 0xC8,0x65,0x91 // Aurora light pink
#define A_Purple  {219,39,21} // 0x6A,0x1B,0x67 // Aurora purple
#define A_Black   {219,39,21} // 0x00,0x00,0x00 // Black (No color)

const uint8_t PROGMEM ledmap[][DRIVER_LED_TOTAL][3] = {
    [_BASE] = {
                AL_Pink,            A_Black,   A_Black,   A_Black,   A_Black,   A_Black,   A_Black,   A_Black,   A_Black,   A_Black,   A_Black, A_Black, A_Black, A_Black, A_Black, A_Black,
                AL_Pink, AB_Yellow, AB_Yellow, AB_Yellow, AB_Yellow, AB_Yellow, AB_Yellow, AB_Yellow, AB_Yellow, AB_Yellow, AB_Yellow, A_Black, A_Black, AL_Pink, A_Black, A_Black, A_Black,
                AL_Pink, A_Blue,    AL_Green,  A_Blue,    A_Blue,    A_Black,   A_Purple,  A_Purple,  A_Black,   A_Black,   A_Black,   A_Black, A_Black, A_Black, A_Black, A_Black, A_Black,
                A_Black, AL_Green,  AL_Green,  AL_Green,  A_Blue,    A_Black,   A_Black,   A_Black,   A_Purple,  A_Black,   A_Black,   A_Black, A_Black, AL_Pink,
                AL_Pink, A_Purple,  A_Purple,  A_Purple,  A_Black,   A_Black,   A_Black,   A_Black,   A_Black,   A_Black,   A_Black,   A_Black, A_Black, AL_Pink,          AL_Pink,
                AL_Pink, A_Black,   A_Black,                                    AL_Pink,                                    A_Black,   A_Black, A_Black, A_Black, AL_Pink, AL_Pink, AL_Pink
            },
};
