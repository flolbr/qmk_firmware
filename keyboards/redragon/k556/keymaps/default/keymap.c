...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = { {   KC_NO,      KC_NO,      KC_NO,      KC_NO,  KC_NO,      KC_NO,  KC_NO,  KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO   },
                ...
                {   KC_LCTL,    KC_LGUI,    KC_LALT,    KC_SPC, KC_RALT,    KC_NO,  KC_APP, KC_NO,      KC_RCTL,    KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_LEFT,    KC_DOWN,    KC_RIGHT,   KC_P0,      KC_NO,      KC_PDOT,    KC_NO   }
              }
};
