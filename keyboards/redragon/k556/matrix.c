...
//    SN_CT16B1->MR0  = led_state[(current_col) + 4].g;

//    SN_CT16B1->MR1  = led_state[(current_col) + 5].r;
//    SN_CT16B1->MR2  = led_state[(current_col) + 5].g;
//    SN_CT16B1->MR3  = led_state[(current_col) + 5].b;
